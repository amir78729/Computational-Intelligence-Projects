...
class NeuralNetwork:
    def __init__(self, input_layer, hidden_layers, output_layer, activation_function):
        self.input_layer = input_layer  # number of neurons in the input layer
        self.hidden_layers = hidden_layers  # number of neurons in the hidden layers (represented by an array of integers)
